                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="grid gap-y-4">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <x-text-input type="password" id="confirm-password" name="password_confirmation" class="w-full" aria-describedby="confirm-password-error" />
                                <div class="hidden absolute inset-y-0 end-0 pointer-events-none pe-3">
                                    <svg class="size-5 text-red-500" width="16" height="16" fill="currentColor" viewBox="0 0 16 16" aria-hidden="true">
                                        <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM8 4a.905.905 0 0 0-.9.995l.35 3.507a.552.552 0 0 0 1.1 0l.35-3.507A.905.905 0 0 0 8 4zm.002 6a1 1 0 1 0 0 2 1 1 0 0 0 0-2z"/>
                                    </svg>
                        ...
                        <div class="flex items-center">
                            <div class="flex">
                                <x-checkbox-input id="accept-terms" name="accept_terms" />
                            </div>
                            <div class="ms-3">
                                <x-input-label for="accept-terms">I accept the <a class="text-blue-600 decoration-2 hover:underline focus:outline-none focus:underline font-medium" href="#">Terms and Conditions</a></x-input-label>
                            </div>
                        </div>
